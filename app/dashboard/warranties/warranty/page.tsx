          ...
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="p-6.5">
              <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                <div className="w-full xl:w-8/12">
                  <label className="mb-2.5 block text-black dark:text-white">
                    Product Key <span className="text-meta-1">*</span>
                  </label>
                  <input
                    disabled
                    type="text"
              ...
              <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                <div className="w-full xl:w-1/2">
                  <label className="mb-2.5 block text-black dark:text-white">
                    Vehicle Year <span className="text-meta-1">*</span>
                  </label>
                  <input
                    disabled
                    type="text"
                ...
                <div className="w-full xl:w-1/2">
                  <label className="mb-2.5 block text-black dark:text-white">
                    Vehicle Make <span className="text-meta-1">*</span>
                  </label>
                  <input
                    disabled
                    type="text"
              ...
              <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                <div className="w-full xl:w-1/2">
                  <label className="mb-2.5 block text-black dark:text-white">
                    Vehicle Number <span className="text-meta-1">*</span>
                  </label>
                  <input
                    disabled
                    type="text"
                ...
                <div className="w-full xl:w-1/2">
                  <label className="mb-2.5 block text-black dark:text-white">
                    Vehicle Chassis No <span className="text-meta-1">*</span>
                  </label>
                  <input
                    disabled
                    type="text"
              ...
              <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                <div className="w-full xl:w-1/2">
                  <label className="mb-2.5 block text-black dark:text-white">
                    Studio Name <span className="text-meta-1">*</span>
                  </label>
                  <input
                    disabled
                    type="text"
                ...
                <div className="w-full xl:w-1/2">
                  <label className="mb-2.5 block text-black dark:text-white">
                    Installer Name <span className="text-meta-1">*</span>
                  </label>
                  <input
                    disabled
                    type="text"
              ...
              <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                ...
                <div className="w-full xl:w-1/2">
                  <label className="mb-2.5 block text-black dark:text-white">
                    Video Link <span className="text-meta-1">*</span>
                  </label>
                  <input
                    disabled
                    type="text"
